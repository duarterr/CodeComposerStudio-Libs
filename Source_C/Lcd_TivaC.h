...
typedef struct
{
    uint32_t Periph;                // SSI peripheral
    uint32_t Base;                  // SSI base address
} lcd_ssi_t;
...
typedef struct
{
    ...
    uint32_t PinMux;                // GPIO pin mux configuration
} lcd_gpio_t;

// Configuration structure
typedef struct
{
    lcd_ssi_t Ssi;                  // SSI configuration
    lcd_gpio_t Sclk;                // SCLK pin configuration
    lcd_gpio_t Dn;                  // DN pin configuration
    lcd_gpio_t Sce;                 // SCE pin configuration
    lcd_gpio_t Dc;                  // DC pin configuration
    lcd_gpio_t Bkl;                 // BKL pin configuration
} lcd_config_t;
